...
schema = Object(
    ...
    attributes=[
        Text(
            ...
            examples=[("I want to know the balance", "balance"), ("I want to swap", "swap"), ("I want to transfer", "transfer"), ("I want to send", "send"), ("I want to know the total supply", "total supply"), ],
        ),
        Text(
            id="address",
